...
// Dirubah 
const pengirim = "Atmin BTC";
const nomorWa = "6281229807496" // awalan nomor 0 harus di awalin 62
const textWa = "Aku mau sinau airdrop bos, tulung"
const pesan = `salken ya Bro, kalo mau penjelasan WFH Web3 Airdrop Hunter klik aja dibawah ini`;

if (pengirim) {
  nama.innerHTML = pengirim;
  nama1.innerHTML = pengirim;
} else {
  nama.innerHTML = "Your name, Bro";
  nama1.innerHTML = "Your name, Bro";
}
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Halo bro, Web3 Airdrop makin cuanable sekarang, tulis nama lu kalo mau saya jelasin',
    html: `<input type="text" id="login" class="swal2-input" placeholder="Your name, Bro">`,
